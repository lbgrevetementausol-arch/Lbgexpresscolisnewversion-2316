...
export const CONFIDENTIALITE: Block[] = [
  ...
  },
  {
    ...
    body: {
      fr: "Vos données sont accessibles à M. Billy Koussala Wola et, pour les seules informations nécessaires à la tournée, au livreur en charge de votre expédition. Sous-traitants techniques : Hostinger (hébergement, Union européenne), Resend (envoi des e-mails transactionnels), myPOS (paiement par carte), Google (API Places pour l'autocomplétion des adresses). À l'international, nos correspondants locaux au Bénin, au Togo et au Mali reçoivent les seules coordonnées du destinataire nécessaires à la remise. Les autorités douanières reçoivent les déclarations obligatoires.",
      en: "Your data is accessible to Mr Billy Koussala Wola and, for round-related information only, to the driver handling your shipment. Technical processors: Hostinger (hosting, European Union), Resend (transactional email delivery), myPOS (card payment), Google (Places API for address autocompletion). For international shipments, our local partners in Benin, Togo and Mali receive only the recipient details required for handover. Customs authorities receive the mandatory declarations.",
    },
  },
  {
